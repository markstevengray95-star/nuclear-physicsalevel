...
["Graphs","On an ordinary decay curve, identify times for halving. For a log graph, ln A = ln A₀ − λt, so a plot of ln A against t is a straight line with gradient −λ.","A negative log-graph gradient gives λ from its magnitude."]
...
["Material choice","Material selection considers neutron absorption, collision effectiveness, thermal properties, chemical stability and engineering suitability. Typical classroom examples include water or graphite as moderators and neutron-absorbing materials for control systems.","AQA asks for factors and examples, not detailed reactor blueprints."]
...
learn:[
["Fuel and radiation","Nuclear fuel and some fission products are radioactive. Safety therefore focuses on limiting unnecessary exposure and containing radioactive material.","Use radiation, activity and half-life concepts to explain why controls are needed."],
...
["Radioactive waste","Waste may contain radionuclides with a range of half-lives and activities. Handling and storage decisions depend on how activity changes over time, radiation type and the need to contain material.","Long half-life does not automatically mean high activity; activity also depends on number of nuclei and λ."],
